...
class UserCreationBody(BaseModel):
    ...
    parent_organization: str= Field(example = 'FUATILIA', description= 'The organization the user belongs to' ) 
...
class UserUpdateBody (BaseModel):
    ...
    user_type :Optional[str]= Field(example = "staff", description="expert/staff/observer")
    parent_organization: Optional[str]= Field(example = 'FUATILIA', description= 'The organization the user belongs to' ) 
